...
# Plot graphic
png(filename = "Plot4.png", width = 480, height= 380)
par(mfrow=c(2,2))

# First figure
plot(data2$DateTime,data2$Global_active_power, xaxt= 'n',type="l", xlab="", ylab = "Global Active Power")
...
# Second figure
plot(data2$DateTime,data2$Voltage, xaxt= 'n',type="l", xlab="datetime", ylab = "Voltage")
axis(1,at=seq(strptime("2007-02-01 00:00:00","%Y-%m-%d %H:%M:%S"),strptime("2007-02-02 23:59:00","%Y-%m-%d %H:%M:%S"), length.out = 3),labels=c("Thu","Fri","Sat"))
...
# Fourth figure
plot(data2$DateTime,data2$Global_reactive_power, xaxt= 'n',type="l", xlab="datetime", ylab = "Global_reactive_power")
axis(1,at=seq(strptime("2007-02-01 00:00:00","%Y-%m-%d %H:%M:%S"),strptime("2007-02-02 23:59:00","%Y-%m-%d %H:%M:%S"), length.out = 3),labels=c("Thu","Fri","Sat"))
